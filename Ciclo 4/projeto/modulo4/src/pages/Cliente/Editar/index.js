...
export const EditarCliente = (props) => {
    ...
    const edtCliente = async e => {
        ...
        await axios.put(api + '/editarcliente', { id, nome, endereco, cidade, uf, nascimento }, { })
            .then((response) => {
            ...
            <h1>
                <Container>
                    ...
                    <Form className="p-2" onSubmit={edtCliente}>
                        ...
                        {status.formSave ? <Button type="submit" outline color="warning" disabled className='m-1'>Aguarde, Salvando... <Spinner children='' color="secondary" /> </Button> :
