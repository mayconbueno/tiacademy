        ...
        <div>
            <Container>
                <div className="d-flex">
                    ...
                    <div className="p-2">
                        <Link to="/visualizarcliente" className="btn btn-outline-warning btn-sm">Listar</Link>
                    </div>
                </div>
                <hr className="m-1" />
                ...
                <Form className="p-2" onSubmit={cadCliente}>
                    ...
                    {status.formSave ? <Button type="submit" outline color="info" disabled>Aguarde, Salvando... <Spinner color="secondary" /> </Button> :
